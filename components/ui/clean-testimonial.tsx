...
const testimonials = [
  ...
  {
    quote: "This work redefined our entire approach to digital experiences. Completely.",
    author: "Elena Frost",
    ...
    >
      ...
      >
        {testimonials.map((t, i) => (
          ...
          >
            <Image src={t.avatar} alt={t.author} width={100} height={100} className="w-full h-full object-cover" />
          </motion.div>
        ))}
      </motion.div>
          ...
          <div className="flex items-center gap-4">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <span className="block text-xs text-white/41 mt-0.5 font-mono uppercase tracking-widest">
